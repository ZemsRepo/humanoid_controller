...
def setup_controllers(context):
    ...
    controllers_config_path = f'config/{organization_value}/{robot_type_value}/real.yaml'
    ...
    active_list = ["state_estimator", "passive_controller"]
    inactive_list = ["damping_controller", "standby_controller", "stand_loop_controller", "motion_tracking_controller", "walking_controller"]
...
def generate_launch_description():
    ...
    robot_description_content = ParameterValue(Command([FindExecutable(name='xacro'), " ", urdf_file, " ", "simulation:=", "false"]), value_type=str)
